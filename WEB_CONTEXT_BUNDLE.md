...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-690-erd-s-problem-690-36e1dd43-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-690"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-690-erd-s-problem-690-36e1dd43-v1",
      "problem_contract_sha256": "4a762f2becae15420f52501d85b689c7a22bf597208055ee61bf614dbf2982ba",
      "problem_id": "problem:um-ep-690-erd-s-problem-690-36e1dd43",
      "route_id": "route:um-ep-690-erd-s-problem-690-36e1dd43-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-690-erd-s-problem-690-36e1dd43-source-fidelity-01",
      "graph_id": "graph:um-ep-690-erd-s-problem-690-36e1dd43-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-690-erd-s-problem-690-36e1dd43-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-690-erd-s-problem-690-36e1dd43-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $d_k(p)$ be the density of those integers whose $k$th smallest prime factor is $p$ (i.e. if $p_1<p_2<\\cdots$ are the primes dividing $n$ then $p_k=p$). For fixed $k\\geq 1$ is $d_k(p)$ unimodular in $p$? That is, it first increases in $p$ until its maximum then decreases."
          },
          "statement_sha256": "25e8247f708d7e354a0204e259a1e3a7de3feec5dee58182d2efb64c647a9b9d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-690-erd-s-problem-690-36e1dd43-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-690-erd-s-problem-690-36e1dd43-root",
      "route_id": "route:um-ep-690-erd-s-problem-690-36e1dd43-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-690-49ccc97aea9e",
        "url": "https://www.unsolvedmath.com/problems/EP-690"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
